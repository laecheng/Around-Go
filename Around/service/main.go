...
const (
	...
	DISTANCE    = "200km"
	ES_URL      = "http://35.196.1.62:9200"
	BUCKET_NAME = "kevin-post-image"
)
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Printf("Parsed lat from client: %v\n", lat)
	fmt.Printf("Parsed lat from client: %v\n", lon)
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	...
	// Creates a client.
	client, err := storage.NewClient(ctx, option.WithCredentialsFile("E:\\keys\\Around-4d648e2f3976.json"))
	if err != nil {
		return nil, err
	}
